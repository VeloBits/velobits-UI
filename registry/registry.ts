 ...
 * `@velobitsdevs/tokens` here rather than typed twice. A palette change flows into
...
const hooks: RegistryItem[] = [
  ...
  },
  {
    ...
    title: 'useMediaQuery',
    description:
      'Media query subscription plus usePrefersReducedMotion. Import breakpoints from @velobitsdevs/tokens rather than re-typing the pixel value, so the JS and CSS breakpoints cannot drift apart.',
...
const ui: RegistryItem[] = [
  ...
  },
  {
    ...
    dependencies: [RADIX, '@velobitsdevs/icons'],
    registryDependencies: ['cn'],
   ...
   * without the token layer gets an unstyled transparent box, not an error. ── */
  {
    ...
    dependencies: ['cmdk', RADIX, '@velobitsdevs/icons'],
    registryDependencies: ['cn', 'velobits-theme'],
  ...
  },
  {
    ...
    dependencies: [CVA, RADIX, '@velobitsdevs/icons'],
    registryDependencies: ['cn', 'velobits-theme'],
  ...
  },
  {
    ...
    dependencies: [RADIX, '@velobitsdevs/icons', '@velobitsdevs/tokens'],
  ...
  },
  {
    ...
    dependencies: [CVA, '@velobitsdevs/icons'],
  ...
  },
  {
    ...
    dependencies: ['@velobitsdevs/icons'],
  ...
  },
  {
    ...
    title: 'Motion',
    description:
      'Page transitions and capped list staggers on framer-motion, which was already a required peer for VelobitsProvider’s MotionConfig and until now bought nothing else. Subpath-only in the npm package (@velobitsdevs/ui/motion), like form, because the barrel’s own-code budget has ~4 kB left and nobody should pay for Framer to import a Button. Reduced motion is handled by MotionConfig and the token layer — do NOT add a third path. Stagger caps at STAGGER_LIMIT items so a 200-row list does not take eight seconds to arrive.',
    dependencies: ['framer-motion'],
    registryDependencies: ['cn'],
...
const themes: RegistryItem[] = [
  {
    ...
    description:
      'The full token layer as CSS variables. Every colour pair here is contrast-verified in both themes by the @velobitsdevs/tokens test suite.',
    cssVars: {
