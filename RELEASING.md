...
| Version published but no tag or GitHub Release        | Publish succeeded, then the tag push or release step failed.                                                                     | Dispatch **Release** on `main`. The release step backfills any tag that has no Release.                    |
