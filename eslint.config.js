...
export default tseslint.config(
   ...
   * (the dashboard app's eslint config, outside components/ui/**) because Lucide's
  ...
  /*
   * Presentational primitives only. Mirrors the rule the dashboard app applies to its
