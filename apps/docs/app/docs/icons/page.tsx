 ...
 * The icon gallery.
 *
 * Until this page existed, `@velobits/icons` shipped 88 glyphs and the docs
      ...
      <main id="main" className="min-w-0 space-y-12 py-8 pb-24">
        <header className="space-y-3">
          ...
          <p className="max-w-3xl leading-7 text-muted-foreground">
            ...
            <code>@velobits/icons</code> appears here without anyone editing this page.
          </p>
        </header>
...
<TrashIcon aria-hidden={undefined} role="img" aria-label="Delete flag" />`}</code>
          ...
          >
            <div className="rounded-xl border border-dashed border-border p-6">
              <pre className="overflow-x-auto font-mono text-xs">
                <code>{`import { createIcon } from '@velobits/icons';
