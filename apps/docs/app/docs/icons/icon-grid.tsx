...
import * as iconModule from '@velobitsdevs/icons';
import { type Icon as IconComponent } from '@velobitsdevs/icons';
import { Badge, EmptyState, Input } from '@velobitsdevs/ui';
import { CheckIcon, SearchIcon } from '@velobitsdevs/icons';
...
function Swatch({ name, Icon }: { name: string; Icon: IconComponent }) {
  ...
  const copy = async () => {
    ...
    await navigator.clipboard.writeText(`import { ${name} } from '@velobitsdevs/icons';`);
    setCopied(true);
