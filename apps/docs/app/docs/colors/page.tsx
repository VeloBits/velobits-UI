...
export const metadata: Metadata = {
  title: 'Colors',
  description:
    'Every semantic token, its contrast gate, and the glass composites — computed from @velobitsdevs/tokens at build time.',
};
...
/**
 * Every value on this page is read from `@velobitsdevs/tokens` at build time.
