...
export const metadata: Metadata = {
  title: 'Colors',
  description:
    'Every semantic token, its contrast gate, and the glass composites — computed from @velobits-dev/tokens at build time.',
};
      ...
      <main id="main" className="min-w-0 space-y-14 py-8 pb-24">
        <section>
          ...
          <p className="max-w-3xl text-muted-foreground">
            Every value below is read from <code>@velobits-dev/tokens</code> at build time and
