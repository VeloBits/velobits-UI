...
import { AlertTriangleIcon } from '@velobitsdevs/icons';
...
const PEER_NOTES: Record<string, string> = {
  ...
  '@velobitsdevs/icons': 'The icon set this component renders glyphs from.',
  '@velobitsdevs/tokens': 'The token layer. Every colour and radius below resolves through it.',
};
